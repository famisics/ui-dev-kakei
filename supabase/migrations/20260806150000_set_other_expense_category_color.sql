...
begin
  ...
  insert into public.categories (
    ...
    (new.id, 'その他', 'expense', '#eab308', 2, true, array['パルコ','ルミネ','ダイマル','ヘップ','キャナル','コピス','ウイングベイ','スクランブルスクエア','フードショー','AMAZON','アマゾン','楽天','ラクテン','メルカリ','MONOTARO','モノタロウ','RAKSUL','ラクスル','テンガ','スイッチボット','ラブメルシ','イラナイマクラ']),
